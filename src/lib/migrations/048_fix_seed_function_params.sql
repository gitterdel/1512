...
-- Create improved seed function with proper parameter handling
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO public.users (
            ...
            now(),
            'Andorra la Vella',
            'Propietario con experiencia en alquileres'
        );
    ...
    EXCEPTION WHEN OTHERS THEN
        ...
        RAISE NOTICE 'Error in seed_initial_data: %', SQLERRM;
        result := jsonb_build_object(
            'success', false,
            'error', SQLERRM,
            'code', SQLSTATE
...
GRANT EXECUTE ON FUNCTION seed_initial_data TO authenticated;