...
-- Create or update reports table
...
CREATE POLICY IF NOT EXISTS "Enable read access for all properties"
    ON public.properties FOR SELECT
    USING (true);

CREATE POLICY IF NOT EXISTS "Enable insert for landlords"
...
CREATE POLICY IF NOT EXISTS "Enable update for property owners"
...
CREATE POLICY IF NOT EXISTS "Enable read access for admins"
